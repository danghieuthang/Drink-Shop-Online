...
public class SearchDrinkController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<DrinkDTO> drinkList = drinkDAO.searchDrink(name, categoryID, priceFrom, priceTo);
            ...
            if (user != null) {
                ArrayList<DrinkDTO> recommendList = drinkDAO.getDrinkRecommendation(user.getEmail());
                request.setAttribute("RECOMMEND_LIST", recommendList);
            }
