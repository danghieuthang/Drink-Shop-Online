 ...
 * @author dhtha
 */
public class ViewDrinkController extends HttpServlet {

    private final String SUCCESS="single_shop.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DrinkDTO drink=dao.getDrinkByID(drinkID);
            request.setAttribute("DRINK", drink);
            url=SUCCESS;
        } catch (Exception e) {
            log("Error at ViewDrinkController: "+e.toString());
        }finally{
