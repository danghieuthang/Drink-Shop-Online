<%-- 
    Document   : checkout
    Created on : Feb 23, 2020, 4:15:52 PM
    Author     : dhtha
--%>
                                        ...
                                        <table class="table site-block-order-table mb-5">
                                            ...
                                            <tbody>
                                                <c:forEach var="rows" items="${sessionScope.CART}">
                                                    <tr>
                                                        <td>${rows.value.drink.name} <strong class="mx-2">x</strong> ${rows.value.quantity}</td>
                                                        <td>$${rows.value.totalPrice}</td>
                                                    </tr>
                                                </c:forEach>
                                                <tr>
                                                    <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
                                                    <td class="text-black">$${requestScope.TOTAL}</td>
                                                </tr>
                                                <tr>
                                            ...
                                            <div class="" id="collapsepaypal">
                                                <div class="py-2 pl-0">
                                                    ...
                                                    <form action="AuthorizePayment" method="POST">
                                                        <button type="submit" class="btn btn-info"><!-- PayPal Logo -->
